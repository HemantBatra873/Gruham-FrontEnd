...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/user/update/${user._id}` , {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  const handleDeleteUser = async(e) => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/user/delete/${user._id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
      const data = await res.json();
  ...
  const handleShowListing = async(e) => {
     try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/user/listings/${user._id}` , {
        credentials: 'include',
      });
      const data = await res.json();
      if(data.success===false){
